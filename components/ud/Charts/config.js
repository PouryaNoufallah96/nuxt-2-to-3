import { parseOptions } from "@/components/ud/Charts/optionHelpers";
...
export let toolTipOptions = {
    ...
    ${sepratePrice(data.datasets[item.datasetIndex].data[item.index])}`,
    },
};

export let isAllDataZero = (data) => {
    return data.reduce((a, b) => a + b) > 0 ? false : true;
};